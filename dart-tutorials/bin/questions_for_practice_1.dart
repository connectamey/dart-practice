...
import 'package:dart_tutorials/functions_questions_for_practice_1.dart' as functions_questions_for_practice_1;

void main(List<String> arguments) {
  print('Write a program to print your name in Dart.');
  print (functions_questions_for_practice_1.printName());
